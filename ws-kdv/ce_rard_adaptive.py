"""
CE-RARD Adaptive-Algorithm - Cirruculum Learning + Residual Based Adaptive Refinement 
"""
import os
import json
import logging
...
def _results_json_path(path_output_parent):
    return os.path.join(path_output_parent, "results_log_kdv_ce_rard_adaptive.json")
...
def solve(
    ...
    logger.info(f"::: gamma1={gamma1} and gamma2={gamma2} and (k,c)=({k},{c}) :::")
    ...
    # ---------- RAR phase ----------
    logger.info("::: Starting RARD training phase...")
