"""
Vanilla + RAR Algorithm - Basic PINNs implementation
...
RATIO = 0.005  # ratio of new points to be added in each RAR iteration
...
def solve(
    ...
    json_file = os.path.join(parent_dir, "results_log_burgers_rarg.json")
